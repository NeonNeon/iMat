 ...
 * <p>The following information is remembered by the IMatDataHandler when an 
 ...
 * </ul>
 * <p>
 * The state is restored automatically the next time the IMatDataHandler is created.
 * @author Grupp16
 *
 */
public class Model {
	...
	// TODO Change to a better category class, a new enum perhaps?
	/**
	 * Returns a list with all the store's Products of a specific
	 * ProductCategory.
	 * 
	 * @param The
	 *            desired ProductCategory.
	 * @return A List of all Products in the specific ProductCategory.
	 */
	 ...
	 * @param p The Product to examine.
	 ...
	 * <p>All is interpreted as name, adress and at least one phone number.
	 ...
	 * <p>Also removes the items currently in the shoppingcart. All orders
	 * are remembered by the IMatDataHandler. This method is shorthand
	 * for placeOrder(true).
	...
	/**
	 * Creates an order from the current contents of the shoppingcart.
	 * <p>All orders are remembered by the IMatDataHandler.
	 ...
	 * <p>Mostly included for development purposes. 
	 * Normally, there should be no reason to call this method.
	 * @param p
	 */
	...
	/**
	 * Resets the IMatDataHandler to its initial state. Mostly useful during development.
	 */
	public void reset() {
		dataBase.reset();
	}
	 ...
	 * <p>Mostly included since this can be useful during development.
	 */
	 ...
	 * <p>The file should exist and is copied into the IMatDataHandler's
	 * storage. Mostly included for development purposes. Normally, there
	 * should be no reason to call this method.
	 * @param p the product
	 * @param f the file.
	 */
	 ...
	 * <p>Should be called when an application using the IMatDataHandler quits.
	 */
